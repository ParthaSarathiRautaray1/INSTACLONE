...
//                         { user?._id === post.author._id && <Badge className="font-semibold" >Author</Badge>
//  }
//                     </div>
...
//            <p>
//                 <span className='font-bold mr-2 font-[Poppins]'>{post.author?.username}</span>
//                 {post.caption}
//            </p>
...
//                         dispatch(setSelectedPost(post))
//                         setOpen(true) 
//                     }} className=' font-[Roboto] font-extrabold cursor-pointer text-sm text-gray-700' >View All {comment.length} Comments</span>
